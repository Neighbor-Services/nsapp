  ...
  Future<void> _submitDispute() async {
    if (_selectedReason == null || _descriptionController.text.trim().isEmpty) {
      customAlert(
        ...
        'Please provide a reason and description.',
      );
    ...
    try {
      ...
      if (mounted) {
        ...
        customAlert(
          ...
          'Failed to submit dispute: ${e.response?.data}',
        );
      }
    } catch (e) {
      if (mounted) {
        ...
        customAlert(context, AlertType.error, 'An unexpected error occurred');
      }
    }
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      if (_evidenceFile != null) ...[
                        ...
                        Text(
                          "File selected: ${_evidenceFile!.path.split('/').last}",
