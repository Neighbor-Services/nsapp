...
class _AuditLogPageState extends State<AuditLogPage> {
  ...
  Color _getColor(String? action) {
    ...
    if (action.contains('LOGIN') || action.contains('REGISTER')) return Colors.blue;
    if (action.contains('FUND') || action.contains('PAYOUT') || action.contains('SUBSCRIPTION')) return Colors.green;
    if (action.contains('DISPUTE') || action.contains('CANCEL') || action.contains('EXPIRE')) return Colors.red;
    if (action.contains('COMPLETE') || action.contains('APPROVE')) return Colors.orange;
        ...
        return Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              _detailRow('Date', log.createdAt != null ? DateFormat('MMMM dd, yyyy').format(log.createdAt!) : 'N/A'),
              _detailRow('Time', log.createdAt != null ? DateFormat('hh:mm:ss a').format(log.createdAt!) : 'N/A'),
  ...
  Widget _detailRow(String label, String value) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          CustomTextWidget(text: label, color: context.appColors.secondaryTextColor, fontSize: 13.sp),
          CustomTextWidget(text: value, fontWeight: FontWeight.w500, fontSize: 13.sp),
        ],
      ),
    );
  }
